/**
 * Created by liuliqing on 15/12/11.
 * 原生js
 * 虽然jquery 什么都可以实现，我们同样提供原生js 实现的方式
 */
            ...
            if(xhr.readyState==1){
                ...
                if(dataType.toUpperCase()=="TEXT") {
                    ...
                    if (success != null){
                        ...
                        success(Unit.newJson(xhr.responseText))
                    }
                }
                xhr=null;
            }
